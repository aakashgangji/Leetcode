...
Explanation: It can be proved that there is no way to create a square field by removing fences.
 here is a large (m - 1) x (n - 1) rectangular field with corners at (1, 1) and (m, n) containing some horizontal and vertical fences given in arrays hFences and vFences respectively.
